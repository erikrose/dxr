...
std_libs = ['arena', 'backtrace', 'collections', 'flate', 'fmt_macros', 'fourcc',
            'getopts', 'glob', 'graphviz', 'green', 'hexfloat', 'libc', 'log',
            'native', 'num', 'rand', 'regex', 'regex_macros', 'rlibc', 'rustc',
            'rustdoc', 'rustuv', 'semver', 'serialize', 'std', 'sync', 'syntax',
            'term', 'test', 'time', 'url', 'uuid', 'uv', 'workcache']
